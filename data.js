...
import { pickRandom } from "./domain.js";

// prefixes for monster name
...
// appelations for monster name
export const appelations = [
    "the Hammer",
    "the Axe",
    "the Sharp",
    "the Jagged",
...
// needed for template "Aura Enchanted"
export const auras = [
    "Might",
    "Holy Fire",
    "Blessed Aim",
...
// templates including all changes to base creature
